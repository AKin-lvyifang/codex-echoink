...
const ZH_CN = {
  ...
  knowledge: {
    ...
    enabled: "启用知识库管理",
    enabledDesc: "开启后，插件才会按下面的每日自动维护和启动补跑设置自动运行；关闭后不会自动跑任务，但仍可打开右侧知识库频道手动对话、收集和维护。",
    backend: "知识库后端",
    ...
    dailyMaintenanceDesc: "仅在 Obsidian 打开时运行；错过后下次打开可补跑。",
    scheduleTime: "每日运行时间",
    catchUp: "启动补跑",
...
const EN: SettingsCopy = {
  ...
  knowledge: {
    ...
    enabledDesc: "Controls automatic maintenance and startup catch-up only. The right-side Knowledge channel remains available for manual work.",
    ...
    dailyMaintenanceDesc: "Runs only while Obsidian is open. Missed runs can catch up next launch.",
