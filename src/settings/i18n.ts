...
const ZH_CN = {
  ...
  knowledge: {
    ...
    retentionDaysDesc: "只清理插件本地历史缓存，不删除 Codex 已归档 thread。",
    ...
    deleteHistoryDatePrompt: "输入日期或范围，例如 2026-06-02、2026-06-01..2026-06-07。只删除插件缓存。",
    deleteHistoryDateInvalid: "日期格式无效",
    clearHistory: "清空历史",
    clearHistoryConfirm: "清空全部知识库历史缓存？不会删除 Codex 已归档 thread。",
...
const EN: SettingsCopy = {
  ...
  knowledge: {
    ...
    retentionDaysDesc: "Only deletes local plugin history cache. Archived Codex threads are not deleted.",
    ...
    deleteHistoryDatePrompt: "Enter a date or range, for example 2026-06-02 or 2026-06-01..2026-06-07. Only plugin cache is deleted.",
    deleteHistoryDateInvalid: "Invalid date format",
    clearHistory: "Clear history",
    clearHistoryConfirm: "Clear all Knowledge history cache? Archived Codex threads are not deleted.",
