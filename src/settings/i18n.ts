...
const ZH_CN = {
  ...
  setup: {
    ...
    agentInstaller: {
      ...
      compactHeading: "安装或切换 Agent",
      subtitle: "三项只做轻量检测；安装、登录和连接只作用于当前选中项。",
      agents: {
...
const EN: SettingsCopy = {
  ...
  setup: {
    ...
    agentInstaller: {
      ...
      compactHeading: "Install or switch Agent",
      subtitle: "All three receive a lightweight check. Installation, sign-in, and connection only run for the selected Agent.",
      agents: {
