...
export const STORAGE_INVENTORY_REPORT_CODES = Object.freeze([
  ...
  "history-active-missing",
  "history-active-schema-invalid",
  ...
  "history-generation-incomplete",
  "history-generation-missing",
