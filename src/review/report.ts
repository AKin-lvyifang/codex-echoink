import type { ChatMessage, CodexForObsidianSettings, ReviewReportKind, StoredSession } from "../settings/settings";
...
export const REVIEW_OUTPUT_DIR = "outputs/obsidian-weekly-review";
