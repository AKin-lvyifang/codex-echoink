...
![Codex EchoInk v1.2.0 发布图 / Release poster](https://raw.githubusercontent.com/AKin-lvyifang/codex-echoink/main/docs/images/codex-echoink-v1.2.0-release.png)
...
**Codex、OpenCode、Hermes 三 Agent 切换**
...
The three screenshots above show the real Home workspace and Agent sidebar, the Codex / OpenCode / Hermes switcher, and the Plan-mode composer in Obsidian.
